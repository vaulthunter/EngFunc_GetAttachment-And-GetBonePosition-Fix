...
#ifdef FN_SetOrigin
void FN_SetOrigin(edict_t *e, const float *vecOrigin);
#endif // FN_SetOrigin
...
void FN_GetBonePosition(const edict_t *pEdict, int iBone, float *vecOrigin, float *rgflAngles);
...
void FN_GetAttachment(const edict_t *pEdict, int iAttachment, float *vecOrigin, float *rgflAngles );
...
void FN_SetOrigin_Post(edict_t *e, const float *vecOrigin);
...
void FN_GetBonePosition_Post(const edict_t *pEdict, int iBone, float *vecOrigin, float *rgflAngles);
...
void FN_GetAttachment_Post(const edict_t *pEdict, int iAttachment, float *vecOrigin, float *rgflAngles );
